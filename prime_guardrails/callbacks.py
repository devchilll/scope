...
def fast_guardrail_callback(
    ...
    if not text_result['is_safe']:
        ...
        # Return a safety refusal response
        # Note: For now, we'll just log and return None to let the agent handle it
        # In production, you'd want to return a proper LlmResponse
